...
public class AuthenticationService {
    ...
    public AuthenticatedUser login(UserCredentials credentials) throws BasicLoggerException {
    ...
    public boolean register(UserCredentials credentials) throws BasicLoggerException {
        HttpEntity<UserCredentials> entity = createCredentialsEntity(credentials);
