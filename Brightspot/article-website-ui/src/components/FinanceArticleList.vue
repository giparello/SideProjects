<template>
  <!--create list of cards for finance articles-->
  <section id="cards">
    <!--v-for to create cards from array-->
    <article
      class="article-card"
...
export default {
  ...
  //get articles by finance tag
  created() {
    articleService.getArticleByTag("Finance").then((response) => {
